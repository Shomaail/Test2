<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" Inherits="Admin_PermanentCommittee" MaintainScrollPositionOnPostback="true" CodeFile="PermanentCommittee.aspx.cs" %>
        ...
        <ContentTemplate>
            <div runat="server" id="divTopOfFormMsgFailure" class="alert alert-danger"
               >
                ...
                <b>Incomplete: </b>
                <asp:Label ID="lblMessageFailure"  runat="server" EnableViewState="False" Font-Italic="True"></asp:Label>
            </div>
            <div runat="server" id="divTopOfFormMsgSuccess" class="alert alert-success" role="alert"
                >
                <span class="glyphicon glyphicon-check" aria-hidden="true"></span>
                <b>Complete:</b>
                <asp:Label ID="lblMessageSuccess"  runat="server" EnableViewState="False" Font-Italic="True"></asp:Label>
            </div>
            <div runat="server" id="divWarningMsg" class="alert alert-warning" role="alert">
                <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>
                    <b>NOTE: </b> <%= Resources.Resource.ScientificCouncilM14 %>
            </div>
            <hr>
            <hr>
            ...
            <hr>
            <div runat="server" id="divSC" class='<%# GetStatus(PermanentCommitteeTypeTitle.Scientific_Council)? "": "disabledbutton" %>'>
                ...
                <tbody>
                    ...
                    <asp:Repeater ID="rptPermanentCommitteeSC" runat="server" ItemType="BL.Data.PermanentCommittee"
                        OnItemCommand="rptPermanentCommitteeSC_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <th scope="row"><%# Container.ItemIndex + 1 %></th>
                                <td><strong><%# Item.Employee.NameString +" ("+Item.Employee.Department1.ShortName+")"%> </strong>
                                    <br />
                                    <%# "(Employee ID:"+ Item.EmployeeID +", Email:"+ Item.Employee.Email+" Phone:"+ Item.Employee.Phone+")"%>
                                    <br />
                                    ...
                                    <asp:LinkButton runat="server" ID="lbtnSearchSC" ToolTip="Search" 
                                        Visible="false"
                                        CommandArgument='<%#Item.PermanentCommitteeID %>' CssClass="btn btn-primary" 
                                ...
                                <td>
                                    <div runat="server" id="divNormalMode" class="btn-groupb btn-group-sm" role="group" aria-label="...">
                                        <asp:LinkButton ID="lbtnEdit" runat="server" CommandArgument="<%# Item.PermanentCommitteeID %>" CommandName="Edit" CssClass="btn btn-success"><i class="fa fa-pencil-square" aria-hidden="true"></i> Edit</asp:LinkButton>
                                        <asp:LinkButton ID="lbtnDelete" OnClientClick="return ShowConfirm(this.id);" runat="server" CommandArgument="<%# Item.PermanentCommitteeID %>" CommandName="Delete" CssClass="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Delete</asp:LinkButton>
                                    </div>
                                    <div runat="server" id="divEditMode" class="btn-groupb btn-group-sm" role="group" aria-label="...">
                                        <asp:LinkButton ID="lbtnUpdate" ToolTip="Update" runat="server" CommandArgument="<%# Item.PermanentCommitteeID %>" CommandName="Update" Visible="false" CssClass="btn btn-success"><i class="fa fa-check-circle" aria-hidden="true"></i> Update</asp:LinkButton>
                                        <asp:LinkButton ID="lbtnCancel" ToolTip="Cancel" runat="server" CommandArgument="<%# Item.PermanentCommitteeID %>" CommandName="Cancel" Visible="false" CssClass="btn btn-success"><i class="fa fa-close" aria-hidden="true"></i> Cancel</asp:LinkButton>
                                    </div>
                                </td>
                            </tr>
                        </ItemTemplate>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <asp:Repeater ID="rptPermanentCommitteeSCCoordinator" runat="server" ItemType="BL.Data.PermanentCommittee"
                        OnItemCommand="rptPermanentCommitteeSCCoordinator_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                <th scope="row"><%# Container.ItemIndex + 1 %></th>
                                <td><strong><%# Item.Employee.NameString +" ("+Item.Employee.Department1.ShortName+")" %> </strong>
                                    ...
                                    <br />
                                    <input type="text" runat="server" class="form-control" id="tbEmployeeIDEdit" visible="false" placeholder="Input Employee ID" value='<%# Item.EmployeeID %>' />
                                    <asp:LinkButton runat="server" ID="lbtnSearchSCC" ToolTip="Search" 
                                        Visible="false"
                                        CommandArgument='<%#Item.PermanentCommitteeID %>' CssClass="btn btn-primary" 
                                        OnClick="lbtnSearchSCC_Click"><i class="fa fa-search" aria-hidden="true"></i>
                                    </asp:LinkButton><asp:Label ID="lblNameEdit" runat="server"></asp:Label>
                                </td>
                                <%--<td><%# Item.ExternalEmployeeID != 0 && Item.ExternalEmployeeID != null ? Item.ExternalEmployee.NameString +" (External Employee ID:"+ Item.ExternalEmployeeID +")" : ""%> </td>                                    --%>
                                <td>
            ...
            <div runat="server" id="divSCSubComm" class='<%# GetStatus(PermanentCommitteeTypeTitle.SC_Subcommittee)? "": "disabledbutton" %>'>
            <h3>Scientific Council Promotion Subcommittee Members</h3>
            <table class="table">
                ...
                <tbody>
                    ...
                    <asp:Repeater ID="rptPermanentCommitteePSubComm" runat="server" ItemType="BL.Data.PermanentCommittee"
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <div runat="server" id="divNormalMode" class="btn-groupb btn-group-sm" role="group" aria-label="...">
                                        <asp:LinkButton ID="lbtnEdit" runat="server" CommandArgument="<%# Item.PermanentCommitteeID %>" 
                                            CommandName="Edit" CssClass="btn btn-success"><i class="fa fa-pencil-square" aria-hidden="true"></i> Edit</asp:LinkButton>
                                        <asp:LinkButton ID="lbtnDelete" OnClientClick="return ShowConfirm(this.id);" runat="server" 
                                            CommandArgument="<%# Item.PermanentCommitteeID %>" CommandName="Delete" CssClass="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Delete</asp:LinkButton>
                                    </div>
                                    <div runat="server" id="divEditMode" class="btn-groupb btn-group-sm" role="group" aria-label="...">
                                        <asp:LinkButton ID="lbtnUpdate" ToolTip="Update" runat="server" 
                                            CommandArgument="<%# Item.PermanentCommitteeID %>" CommandName="Update" Visible="false" 
                                        ...
                                        <asp:LinkButton ID="lbtnCancel" ToolTip="Cancel" runat="server" 
                                            CommandArgument="<%# Item.PermanentCommitteeID %>" CommandName="Cancel" Visible="false" 
