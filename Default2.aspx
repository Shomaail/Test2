...
<body>
    <form id="formshomaail" runat="server">
    <div>
    <style type="text/css">
    ...
    <table class="PointsTable" cellpadding="0" cellspacing="0" border="1" bordercolor="#007d40" style="border-collapse:collapse" id="Table1" runat="server">
