<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Forms.master" AutoEventWireup="true" Inherits="Forms_PermanentCommittee" MaintainScrollPositionOnPostback="true" CodeFile="PermanentCommittee.aspx.cs" %>
                    ...
                    <asp:Repeater ID="rptPermanentCommitteePSubComm" runat="server" ItemType="BL.Data.Application_Role"
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><strong><%# Item.Employee.NameString+" ("+Item.Employee.Department1.ShortName+")" %> </strong>
                                    <br />
                                    <%# "(Employee ID:"+ Item.EmployeeID +", Email:"+ Item.Employee.Email+", Phone:"+ Item.Employee.Phone+")"%>                                    <br />
                                    <input type="text" runat="server" class="form-control" id="tbEmployeeIDEdit" visible="false" placeholder="Input Employee ID" value='<%# Item.EmployeeID %>' />
